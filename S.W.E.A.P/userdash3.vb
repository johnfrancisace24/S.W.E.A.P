...
Public Class userdash3
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        ...
        End If
    End Sub
    Private Sub Userdash_Load(sender As Object, e As EventArgs) Handles MyBase.Load   '----USERDASHBOARD---'
        pnldashboard.Show()
        pnlprofile.Hide()
        pnlBeneficiary.Hide()
        pnlBeneficiary.Hide()
        ...
        DG_Load()
    End Sub
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click  '---DASHBOARD-----'
        pnldashboard.Show()
        pnlprofile.Hide()
        pnlsetting.Hide()
        pnlBeneficiary.Hide()
    End Sub
    Private Sub Guna2Button3_Click(sender As Object, e As EventArgs) Handles Guna2Button3.Click   '-----PROFILE-----'
        pnlprofile.Show()
        pnldashboard.Hide()
        pnlsetting.Hide()
        pnlBeneficiary.Hide()
    End Sub
    Private Sub Guna2Button4_Click(sender As Object, e As EventArgs) Handles Guna2Button4.Click  '----BENEFICIARY----'
        pnlBeneficiary.Show()
        pnlprofile.Hide()
        pnlsetting.Hide()
        pnldashboard.Hide()
    ...
    Private Sub Guna2Button7_Click(sender As Object, e As EventArgs) Handles Guna2Button7.Click
        ...
        pnldashboard.Hide()
    End Sub
    Private Sub Guna2Button6_Click(sender As Object, e As EventArgs) Handles Guna2Button6.Click   '-------SETTING-----'
        pnlsetting.Show()
        pnldashboard.Hide()
        pnlprofile.Hide()
        pnlBeneficiary.Hide()
    End Sub
    Private Sub Guna2Button5_Click(sender As Object, e As EventArgs) Handles Guna2Button5.Click  '----LOG OUT----'
        ...
        End If
    End Sub
    Private Sub search_TextChanged(sender As Object, e As EventArgs) Handles search.TextChanged '-----SEARCH---------'
        ...
        End Try
    End Sub
    Public Sub DG_Load() '--------DATAGRID VIEW-------'
        BeneficiariesDGV.Rows.Clear()
        Try
            conn.Open()
        ...
        End Try
    End Sub
    Public Sub Get_info()   '--------GET ALL DATA---------'
