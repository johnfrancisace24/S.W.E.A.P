...
Partial Class signups
    ...
    Private Sub InitializeComponent()
        ...
        dateBday = New Guna.UI2.WinForms.Guna2DateTimePicker()
        Label2 = New Label()
        ...
        txtBA5 = New Guna.UI2.WinForms.Guna2TextBox()
        txtBA4 = New Guna.UI2.WinForms.Guna2TextBox()
        txtBA3 = New Guna.UI2.WinForms.Guna2TextBox()
        ...
        ' Panel1
        ' 
        Panel1.BackColor = Color.FromArgb(CByte(251), CByte(197), CByte(49))
        ...
        Guna2ControlBox2.CustomizableEdges = CustomizableEdges81
        Guna2ControlBox2.Dock = DockStyle.Right
        Guna2ControlBox2.FillColor = Color.Transparent
        Guna2ControlBox2.IconColor = Color.Black
        Guna2ControlBox2.Location = New Point(963, 0)
        Guna2ControlBox2.Name = "Guna2ControlBox2"
        Guna2ControlBox2.ShadowDecoration.CustomizableEdges = CustomizableEdges82
        Guna2ControlBox2.Size = New Size(40, 33)
        ...
        Guna2ControlBox1.CustomizableEdges = CustomizableEdges83
        ...
        Guna2ControlBox1.Location = New Point(1003, 0)
        Guna2ControlBox1.Name = "Guna2ControlBox1"
        Guna2ControlBox1.ShadowDecoration.CustomizableEdges = CustomizableEdges84
        ...
        Panel2.Name = "Panel2"
        Panel2.Size = New Size(1043, 40)
        Panel2.TabIndex = 1
        ' 
        ' Label1
        ' 
        Label1.BackColor = Color.FromArgb(CByte(255), CByte(251), CByte(250))
        Label1.Dock = DockStyle.Top
        Label1.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        Label1.Location = New Point(0, 0)
        Label1.Name = "Label1"
        Label1.Size = New Size(1043, 40)
        Label1.TabIndex = 0
        ...
        Guna2TabControl1.Location = New Point(0, 73)
        Guna2TabControl1.Name = "Guna2TabControl1"
        Guna2TabControl1.SelectedIndex = 0
        Guna2TabControl1.Size = New Size(1043, 412)
        ...
        ' TabPage1
        ' 
        TabPage1.BackColor = Color.FromArgb(CByte(237), CByte(231), CByte(230))
        TabPage1.Controls.Add(Panel3)
        TabPage1.Location = New Point(4, 44)
        TabPage1.Name = "TabPage1"
        TabPage1.Padding = New Padding(10)
        TabPage1.Size = New Size(1035, 364)
        TabPage1.TabIndex = 0
        ...
        Guna2Button1.Location = New Point(809, 272)
        ...
        ' dateBday
        ' 
        dateBday.BorderRadius = 5
        dateBday.Checked = True
        dateBday.CustomizableEdges = CustomizableEdges5
        dateBday.Font = New Font("Segoe UI", 9.0F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        txtEduc.CustomizableEdges = CustomizableEdges7
        txtEduc.DefaultText = ""
        ...
        txtEmail.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtEmail.ForeColor = Color.Black
        txtEmail.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtEmail.Location = New Point(358, 191)
        ...
        txtContact.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtContact.ForeColor = Color.Black
        txtContact.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtContact.Location = New Point(34, 191)
        ...
        txtContact.Size = New Size(289, 36)
        ...
        txtAddress.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtAddress.ForeColor = Color.Black
        txtAddress.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtAddress.Location = New Point(34, 117)
        ...
        txtAddress.Size = New Size(921, 36)
        ...
        Label17.Location = New Point(666, 167)
        ...
        Label18.Location = New Point(358, 167)
        ...
        Label23.Location = New Point(34, 167)
        ...
        Label24.Location = New Point(34, 94)
        ...
        Label28.Location = New Point(828, 20)
        ...
        pickSex.CustomizableEdges = CustomizableEdges15
        ...
        pickSex.Location = New Point(828, 44)
        pickSex.Name = "pickSex"
        pickSex.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        ...
        txtLname.CustomizableEdges = CustomizableEdges17
        ...
        txtLname.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtLname.ForeColor = Color.Black
        txtLname.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtLname.Location = New Point(564, 44)
        ...
        txtMname.CustomizableEdges = CustomizableEdges19
        ...
        Label25.Location = New Point(564, 20)
        ...
        txtFname.CustomizableEdges = CustomizableEdges21
        ...
        Label26.Location = New Point(299, 20)
        ...
        Label27.Location = New Point(34, 20)
        ...
        TabPage2.Controls.Add(comboCommit)
        TabPage2.Controls.Add(comboEmployStat)
        TabPage2.Controls.Add(comboPos)
        TabPage2.Controls.Add(Label10)
        TabPage2.Controls.Add(Label11)
        TabPage2.Controls.Add(Label8)
        TabPage2.Controls.Add(comboOffice)
        TabPage2.Controls.Add(Label29)
        TabPage2.Location = New Point(4, 44)
        TabPage2.Name = "TabPage2"
        TabPage2.Padding = New Padding(3)
        TabPage2.Size = New Size(1035, 364)
        TabPage2.TabIndex = 1
        TabPage2.Text = "Work Information"
        ' 
        ' Guna2Button6
        ' 
        ...
        comboCommit.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        comboCommit.Location = New Point(558, 222)
        ...
        comboEmployStat.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        comboEmployStat.Location = New Point(143, 222)
        ...
        comboPos.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        comboPos.Location = New Point(558, 95)
        ...
        Label10.Location = New Point(559, 201)
        ...
        Label11.Location = New Point(142, 201)
        ...
        Label8.Location = New Point(559, 73)
        Label8.Name = "Label8"
        ...
        comboOffice.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        comboOffice.Location = New Point(142, 94)
        ...
        Label29.Location = New Point(143, 73)
        ...
        ' TabPage3
        ' 
        TabPage3.BackColor = Color.FromArgb(CByte(237), CByte(231), CByte(230))
        TabPage3.Controls.Add(Panel4)
        TabPage3.Location = New Point(4, 44)
        TabPage3.Name = "TabPage3"
        TabPage3.Size = New Size(1035, 364)
        TabPage3.TabIndex = 2
        TabPage3.Text = "Beneficiaries"
        ' 
        ' Panel4
        ' 
        ...
        Panel4.Controls.Add(txtBA5)
        Panel4.Controls.Add(txtBA4)
        Panel4.Controls.Add(txtBA3)
        Panel4.Controls.Add(txtbxBR5)
        Panel4.Controls.Add(txtbxBR4)
        Panel4.Controls.Add(txtbxBR3)
        Panel4.Controls.Add(txtbxBF5)
        Panel4.Controls.Add(txtbxBF4)
        Panel4.Controls.Add(txtbxBF3)
        Panel4.Controls.Add(txtBA2)
        Panel4.Controls.Add(txtbxBR2)
        Panel4.Controls.Add(txtbxBF2)
        Panel4.Controls.Add(txtBA1)
        Panel4.Controls.Add(txtbxBR1)
        Panel4.Controls.Add(txtbxBF1)
        Panel4.Controls.Add(Label20)
        Panel4.Controls.Add(Label21)
        Panel4.Controls.Add(Label22)
        Panel4.Location = New Point(26, 13)
        Panel4.Name = "Panel4"
        Panel4.Size = New Size(987, 337)
        Panel4.TabIndex = 116
        ' 
        ' Guna2Button7
        ' 
        ...
        Guna2Button7.Font = New Font("Segoe UI", 9.0F, FontStyle.Regular, GraphicsUnit.Point)
        Guna2Button7.ForeColor = Color.White
        Guna2Button7.Location = New Point(576, 272)
        Guna2Button7.Name = "Guna2Button7"
        Guna2Button7.ShadowDecoration.CustomizableEdges = CustomizableEdges36
        Guna2Button7.Size = New Size(173, 45)
        Guna2Button7.TabIndex = 116
        ...
        Guna2Button3.Location = New Point(755, 272)
        Guna2Button3.Name = "Guna2Button3"
        Guna2Button3.ShadowDecoration.CustomizableEdges = CustomizableEdges38
        Guna2Button3.Size = New Size(173, 45)
        Guna2Button3.TabIndex = 15
        Guna2Button3.Text = "NEXT"
        ' 
        ' txtBA5
        ' 
        txtBA5.BorderColor = SystemColors.ButtonShadow
        txtBA5.BorderRadius = 5
        txtBA5.CustomizableEdges = CustomizableEdges39
        txtBA5.DefaultText = ""
        txtBA5.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtBA5.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtBA5.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA5.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA5.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA5.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtBA5.ForeColor = Color.Black
        txtBA5.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA5.Location = New Point(758, 220)
        txtBA5.Margin = New Padding(0)
        txtBA5.Name = "txtBA5"
        txtBA5.PasswordChar = ChrW(0)
        txtBA5.PlaceholderText = ""
        txtBA5.SelectedText = ""
        txtBA5.ShadowDecoration.CustomizableEdges = CustomizableEdges40
        txtBA5.Size = New Size(166, 36)
        txtBA5.TabIndex = 14
        ' 
        ' txtBA4
        ' 
        txtBA4.BorderColor = SystemColors.ButtonShadow
        txtBA4.BorderRadius = 5
        txtBA4.CustomizableEdges = CustomizableEdges41
        txtBA4.DefaultText = ""
        txtBA4.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtBA4.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtBA4.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA4.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA4.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA4.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtBA4.ForeColor = Color.Black
        txtBA4.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA4.Location = New Point(758, 175)
        txtBA4.Margin = New Padding(0)
        txtBA4.Name = "txtBA4"
        txtBA4.PasswordChar = ChrW(0)
        txtBA4.PlaceholderText = ""
        txtBA4.SelectedText = ""
        txtBA4.ShadowDecoration.CustomizableEdges = CustomizableEdges42
        txtBA4.Size = New Size(166, 36)
        txtBA4.TabIndex = 11
        ' 
        ' txtBA3
        ' 
        txtBA3.BorderColor = SystemColors.ButtonShadow
        txtBA3.BorderRadius = 5
        txtBA3.CustomizableEdges = CustomizableEdges43
        txtBA3.DefaultText = ""
        txtBA3.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtBA3.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtBA3.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA3.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA3.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA3.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtBA3.ForeColor = Color.Black
        txtBA3.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA3.Location = New Point(758, 131)
        txtBA3.Margin = New Padding(0)
        txtBA3.Name = "txtBA3"
        txtBA3.PasswordChar = ChrW(0)
        txtBA3.PlaceholderText = ""
        txtBA3.SelectedText = ""
        txtBA3.ShadowDecoration.CustomizableEdges = CustomizableEdges44
        txtBA3.Size = New Size(166, 36)
        txtBA3.TabIndex = 8
        ' 
        ' txtbxBR5
        ' 
        ...
        txtbxBR5.CustomizableEdges = CustomizableEdges45
        ...
        txtbxBR5.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBR5.ForeColor = Color.Black
        txtbxBR5.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBR5.Location = New Point(461, 220)
        ...
        txtbxBR5.ShadowDecoration.CustomizableEdges = CustomizableEdges46
        txtbxBR5.Size = New Size(279, 36)
        txtbxBR5.TabIndex = 13
        ' 
        ' txtbxBR4
        ' 
        txtbxBR4.BorderColor = SystemColors.ButtonShadow
        txtbxBR4.BorderRadius = 5
        txtbxBR4.CustomizableEdges = CustomizableEdges47
        ...
        txtbxBR4.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBR4.ForeColor = Color.Black
        txtbxBR4.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBR4.Location = New Point(461, 175)
        ...
        txtbxBR4.ShadowDecoration.CustomizableEdges = CustomizableEdges48
        txtbxBR4.Size = New Size(279, 36)
        txtbxBR4.TabIndex = 10
        ' 
        ' txtbxBR3
        ' 
        txtbxBR3.BorderColor = SystemColors.ButtonShadow
        txtbxBR3.BorderRadius = 5
        txtbxBR3.CustomizableEdges = CustomizableEdges49
        ...
        txtbxBR3.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBR3.ForeColor = Color.Black
        txtbxBR3.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBR3.Location = New Point(461, 131)
        ...
        txtbxBR3.ShadowDecoration.CustomizableEdges = CustomizableEdges50
        ...
        txtbxBF5.CustomizableEdges = CustomizableEdges51
        ...
        txtbxBF5.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBF5.ForeColor = Color.Black
        txtbxBF5.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBF5.Location = New Point(59, 220)
        ...
        txtbxBF5.ShadowDecoration.CustomizableEdges = CustomizableEdges52
        txtbxBF5.Size = New Size(384, 36)
        txtbxBF5.TabIndex = 12
        ' 
        ' txtbxBF4
        ' 
        txtbxBF4.BorderColor = SystemColors.ButtonShadow
        txtbxBF4.BorderRadius = 5
        txtbxBF4.CustomizableEdges = CustomizableEdges53
        ...
        txtbxBF4.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBF4.ForeColor = Color.Black
        txtbxBF4.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBF4.Location = New Point(59, 174)
        ...
        txtbxBF4.ShadowDecoration.CustomizableEdges = CustomizableEdges54
        ...
        txtbxBF3.CustomizableEdges = CustomizableEdges55
        ...
        txtbxBF3.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBF3.ForeColor = Color.Black
        txtbxBF3.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBF3.Location = New Point(59, 131)
        ...
        txtbxBF3.ShadowDecoration.CustomizableEdges = CustomizableEdges56
        txtbxBF3.Size = New Size(384, 36)
        txtbxBF3.TabIndex = 6
        ' 
        ' txtBA2
        ' 
        txtBA2.BorderColor = SystemColors.ButtonShadow
        txtBA2.BorderRadius = 5
        txtBA2.CustomizableEdges = CustomizableEdges57
        txtBA2.DefaultText = ""
        txtBA2.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtBA2.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtBA2.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA2.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA2.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA2.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtBA2.ForeColor = Color.Black
        txtBA2.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA2.Location = New Point(758, 88)
        txtBA2.Margin = New Padding(0)
        txtBA2.Name = "txtBA2"
        txtBA2.PasswordChar = ChrW(0)
        txtBA2.PlaceholderText = ""
        txtBA2.SelectedText = ""
        txtBA2.ShadowDecoration.CustomizableEdges = CustomizableEdges58
        txtBA2.Size = New Size(166, 36)
        txtBA2.TabIndex = 5
        ' 
        ' txtbxBR2
        ' 
        ...
        txtbxBR2.CustomizableEdges = CustomizableEdges59
        ...
        txtbxBR2.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBR2.ForeColor = Color.Black
        txtbxBR2.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBR2.Location = New Point(461, 88)
        ...
        txtbxBR2.ShadowDecoration.CustomizableEdges = CustomizableEdges60
        ...
        txtbxBF2.CustomizableEdges = CustomizableEdges61
        ...
        txtbxBF2.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBF2.ForeColor = Color.Black
        txtbxBF2.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBF2.Location = New Point(59, 88)
        ...
        txtbxBF2.ShadowDecoration.CustomizableEdges = CustomizableEdges62
        txtbxBF2.Size = New Size(384, 36)
        txtbxBF2.TabIndex = 3
        ' 
        ' txtBA1
        ' 
        txtBA1.BorderColor = SystemColors.ButtonShadow
        txtBA1.BorderRadius = 5
        txtBA1.CustomizableEdges = CustomizableEdges63
        txtBA1.DefaultText = ""
        txtBA1.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtBA1.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtBA1.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA1.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtBA1.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA1.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtBA1.ForeColor = Color.Black
        txtBA1.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtBA1.Location = New Point(758, 45)
        txtBA1.Margin = New Padding(0)
        txtBA1.Name = "txtBA1"
        txtBA1.PasswordChar = ChrW(0)
        txtBA1.PlaceholderText = ""
        txtBA1.SelectedText = ""
        txtBA1.ShadowDecoration.CustomizableEdges = CustomizableEdges64
        txtBA1.Size = New Size(166, 36)
        txtBA1.TabIndex = 2
        ' 
        ' txtbxBR1
        ' 
        ...
        txtbxBR1.CustomizableEdges = CustomizableEdges65
        ...
        txtbxBR1.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBR1.ForeColor = Color.Black
        txtbxBR1.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBR1.Location = New Point(461, 45)
        ...
        txtbxBR1.ShadowDecoration.CustomizableEdges = CustomizableEdges66
        ...
        txtbxBF1.CustomizableEdges = CustomizableEdges67
        ...
        txtbxBF1.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxBF1.ForeColor = Color.Black
        txtbxBF1.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxBF1.Location = New Point(59, 45)
        ...
        txtbxBF1.ShadowDecoration.CustomizableEdges = CustomizableEdges68
        ...
        Label20.Location = New Point(818, 24)
        ...
        Label21.Location = New Point(517, 24)
        ...
        Label22.Location = New Point(194, 24)
        ...
        ' TabPage4
        ' 
        TabPage4.BackColor = Color.FromArgb(CByte(237), CByte(231), CByte(230))
        TabPage4.Controls.Add(Guna2Button4)
        TabPage4.Controls.Add(txtbxPass)
        TabPage4.Controls.Add(txtbxUser)
        TabPage4.Controls.Add(bttnUpload)
        TabPage4.Controls.Add(pBoxProfile)
        TabPage4.Controls.Add(Label14)
        TabPage4.Controls.Add(Label13)
        TabPage4.Location = New Point(4, 44)
        TabPage4.Name = "TabPage4"
        TabPage4.Size = New Size(1035, 364)
        TabPage4.TabIndex = 3
        ...
        txtbxPass.CustomizableEdges = CustomizableEdges71
        ...
        txtbxPass.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        txtbxUser.Font = New Font("Calisto MT", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
        txtbxUser.ForeColor = Color.Black
        txtbxUser.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtbxUser.Location = New Point(173, 106)
        ...
        txtbxUser.ShadowDecoration.CustomizableEdges = CustomizableEdges74
        txtbxUser.Size = New Size(279, 36)
        txtbxUser.TabIndex = 109
        ' 
        ' bttnUpload
        ' 
        bttnUpload.BorderRadius = 10
        bttnUpload.CustomizableEdges = CustomizableEdges75
        ...
        bttnUpload.Location = New Point(650, 284)
        bttnUpload.Name = "bttnUpload"
        bttnUpload.ShadowDecoration.CustomizableEdges = CustomizableEdges76
        bttnUpload.Size = New Size(233, 37)
        bttnUpload.TabIndex = 108
        ...
        pBoxProfile.CustomizableEdges = CustomizableEdges77
        pBoxProfile.FillColor = Color.Transparent
        pBoxProfile.ImageRotate = 0F
        pBoxProfile.Location = New Point(650, 43)
        pBoxProfile.Name = "pBoxProfile"
        pBoxProfile.ShadowDecoration.CustomizableEdges = CustomizableEdges78
        pBoxProfile.Size = New Size(233, 227)
        pBoxProfile.TabIndex = 107
        ...
        Label14.Location = New Point(185, 178)
        ...
        Label13.Location = New Point(185, 87)
    ...
    Friend WithEvents dateBday As Guna.UI2.WinForms.Guna2DateTimePicker
    ...
    Friend WithEvents txtBA5 As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents txtBA4 As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents txtBA3 As Guna.UI2.WinForms.Guna2TextBox
