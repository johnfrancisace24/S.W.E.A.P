...
Partial Class user_dashboard
    ...
    Private Sub InitializeComponent()
        ...
        Guna2Panel2.Controls.Add(txtUdues)
        ...
        ' txtUdues
        ' 
        txtUdues.AutoSize = True
        txtUdues.ForeColor = Color.Green
        txtUdues.Location = New Point(54, 85)
        txtUdues.Name = "txtUdues"
        txtUdues.Size = New Size(44, 45)
        txtUdues.TabIndex = 4
        txtUdues.Text = "..."
        ' 
        ' Label32
    ...
    Friend WithEvents txtUdues As Label
    ...
    Friend WithEvents txtBreavement As Label
