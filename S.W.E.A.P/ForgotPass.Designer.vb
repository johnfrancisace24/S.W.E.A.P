...
Partial Class ForgotPass
    ...
    Private Sub InitializeComponent()
        ...
        Page1 = New TabPage()
        bttnbckLogin = New Guna.UI2.WinForms.Guna2Button()
        bttnNextCred = New Guna.UI2.WinForms.Guna2Button()
        ...
        Guna2TabControl1.Controls.Add(Page1)
        Guna2TabControl1.Controls.Add(Page2)
        Guna2TabControl1.Controls.Add(Page3)
        Guna2TabControl1.ItemSize = New Size(160, 40)
        Guna2TabControl1.Location = New Point(52, 148)
        Guna2TabControl1.Name = "Guna2TabControl1"
        Guna2TabControl1.SelectedIndex = 0
        Guna2TabControl1.Size = New Size(696, 417)
        ...
        Guna2TabControl1.TabButtonSize = New Size(160, 40)
        Guna2TabControl1.TabIndex = 5
        Guna2TabControl1.TabMenuBackColor = Color.FromArgb(CByte(33), CByte(42), CByte(57))
        ' 
        ' Page1
        ' 
        Page1.Controls.Add(bttnbckLogin)
        Page1.Controls.Add(bttnNextCred)
        Page1.Controls.Add(Guna2PictureBox2)
        Page1.Controls.Add(Label2)
        Page1.Controls.Add(txtEmail)
        Page1.Controls.Add(Label1)
        Page1.Controls.Add(txtUname)
        Page1.Controls.Add(Label27)
        Page1.Location = New Point(164, 4)
        Page1.Name = "Page1"
        Page1.Padding = New Padding(3)
        Page1.Size = New Size(528, 409)
        Page1.TabIndex = 0
        Page1.Text = "CREDENTIALS"
        ...
        bttnbckLogin.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        bttnbckLogin.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        bttnNextCred.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        bttnNextCred.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        Label2.TabIndex = 104
        Label2.Text = "Provide your account's Username to identify your Email " & vbCrLf & "for which you want to reset your password."
        ...
        txtEmail.Location = New Point(102, 251)
        ...
        Label1.Location = New Point(102, 227)
        Label1.Name = "Label1"
        ...
        txtUname.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtUname.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtUname.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtUname.Font = New Font("Calisto MT", 12F, FontStyle.Regular, GraphicsUnit.Point)
        txtUname.ForeColor = Color.Black
        txtUname.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtUname.Location = New Point(102, 181)
        ...
        Label27.Location = New Point(102, 157)
        ...
        Page2.Controls.Add(Label8)
        Page2.Controls.Add(Guna2Button1)
        Page2.Location = New Point(164, 4)
        Page2.Name = "Page2"
        Page2.Size = New Size(528, 409)
        Page2.TabIndex = 2
        ...
        txtOtpVerify.CustomizableEdges = CustomizableEdges13
        ...
        txtOtpVerify.ShadowDecoration.CustomizableEdges = CustomizableEdges14
        ...
        Label9.Location = New Point(102, 174)
        Label9.Name = "Label9"
        Label9.Size = New Size(145, 18)
        Label9.TabIndex = 118
        Label9.Text = "4 DIGITS OTP CODE"
        ' 
        ' Guna2PictureBox4
        ' 
        ...
        Label8.Location = New Point(126, 90)
        Label8.Name = "Label8"
        Label8.Size = New Size(276, 42)
        Label8.TabIndex = 106
        Label8.Text = "Enter the verification code we just sent" & vbCrLf & "on your email address."
        ...
        Page3.Name = "Page3"
        Page3.Padding = New Padding(3)
        Page3.Size = New Size(528, 409)
        Page3.TabIndex = 1
        ...
        Label5.Location = New Point(152, 105)
        Label5.Name = "Label5"
        Label5.Size = New Size(225, 42)
        Label5.TabIndex = 110
        ...
        txtConfirmPass.CustomizableEdges = CustomizableEdges27
        ...
        txtConfirmPass.ShadowDecoration.CustomizableEdges = CustomizableEdges28
        ...
        Label6.Location = New Point(102, 242)
        Label6.Name = "Label6"
        Label6.Size = New Size(164, 18)
        Label6.TabIndex = 109
        ...
        txtNewPass.CustomizableEdges = CustomizableEdges29
        ...
        txtNewPass.ShadowDecoration.CustomizableEdges = CustomizableEdges30
        ...
        Label7.Location = New Point(102, 172)
        Label7.Name = "Label7"
        ...
        Panel1.Location = New Point(52, 41)
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(696, 86)
        Panel1.TabIndex = 6
        ' 
        ' Label4
        ' 
        ...
        Label4.Location = New Point(217, 25)
        Label4.Name = "Label4"
        Label4.Size = New Size(279, 37)
        Label4.TabIndex = 3
